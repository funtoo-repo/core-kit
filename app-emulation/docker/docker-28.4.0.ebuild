...
SRC_URI="https://github.com/moby/moby/tarball/633e1bde3520fca9dbd7a4bdb31e6c8e124e6bb6 -> moby-28.4.0-633e1bd.tar.gz"
...
src_compile() {
	export DOCKER_GITCOMMIT="633e1bd"
	export GOPATH="${WORKDIR}/${P}"
	export VERSION="28.4.0-funtoo"
