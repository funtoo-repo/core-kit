...
SRC_URI="https://ftp.gnu.org/gnu/miscfiles/miscfiles-1.5.tar.gz -> miscfiles-1.5.tar.gz
https://distfiles.gentoo.org/distfiles/0b/UnicodeData-10.0.0.txt.xz -> UnicodeData-10.0.0.txt.xz"
